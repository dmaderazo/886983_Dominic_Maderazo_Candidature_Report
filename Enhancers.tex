    ...
    % Transcription factors are important because they modify the transcriptional machinery
        ...
        % DNA found in histone methylated regions are wound tightly around histones and genes associated with these regions are typically transcriptionally silent. 
...
% \end{itemize}
        ...
        \textbf{SOME OF THE PROBLEM THAT WE HAVE WHEN TRYING TO FIND ENHANCERS IS THAT:
            \begin{itemize}
